...
<script type="application/javascript"
	src="https://code.jquery.com/jquery3.5.1.min.js"></script>
		...
		<div style="display: flex">
			...
			<div class="menu" style="margin-right: 580px;">
				<ul>
					...
					<li style="margin-left: 580px;"><a href="homepage.html">HOME</a></li>
					<li style="margin-left: 80px"><a href="loginDemo.html">BACK</a></li>
				</ul>
			</div>
		</div>
	</div>
				...
				<div>
					...
					<div class="card-body p-4 p-md-5 ">
						<h3 class="mb-4 pb-2 pb-md-0 mb-md-5"
							style="color: rgb(255, 255, 255);">Registration Form</h3>
						<form id="registerForm" modelAttribute="login"
							action="reg" name="regform" method="post">
								...
								<div class="col-md-4 mb-4">
									...
									<div class="form-outline">
										<label class="form-label" for="fname"
											style="color: rgb(248, 246, 246);">First Name<span
								...
								<div class="col-md-4 mb-4">
									...
									<div class="form-outline">
										<label class="form-label" for="email"
											style="color: rgb(242, 238, 238);">Email <span
											style="color: red;"> *</span></label> <input type="email" id="email"
											name="email" onkeydown="validation()"
											class="form-control form-control-lg"
											placeholder="aaa@gmail.com" required /> <span
											id="error_email" class="text-danger"></span>
									...
									<div class="col-md-4 mb-4 d-flex align-items-center">
										...
										<div class="form-outline datepicker w-100">
											<label for="birthdayDate" class="form-label"
												style="color: rgb(248, 243, 243);">Date of Birth <span
												style="color: red;"> *</span></label> <input type="date"
												class="form-control form-control-lg" name="dob" id="dob" />
									...
									<div class="col-md-4 mb-4">
										<div class="form-outline"
											...
											<label class="form-label" for="address"
												style="color: rgb(243, 241, 241);"> Address <span
												style="color: red;"> *</span></label> <input type="text"
												id="address" class="form-control form-control-lg"
												name="address" placeholder="Address" /> <span
												id="error_address" class="text-danger"></span>
										</div>
									</div>

									<div class="col-md-4 mb-4">
										<div class="form-outline"
											style="margin-left: 15px; width: 390px;">
											<label class="form-label" for="phonenumber"
												style="color: rgb(246, 243, 243);"> Contact Number <span
												style="color: red;"> *</span></label> <input type="tel"
												id="phonenumber" name="mobileno"
												class="form-control form-control-lg"
												placeholder="Mobile Number" /> <span id="error_number"
												class="text-danger"></span>
										</div>
									</div>
								</div>
									...
									<div class="col-md-4 mb-4">
										...
										<div class="form-outline">
											<label class="form-label" for="username"
												style="color: rgb(251, 247, 247);">User Name <span
												style="color: red;"> *</span></label> <input type="text"
									...
									<div class="col-md-4 mb-4">
										...
										<div class="form-outline">
											<label class="form-label" for="password"
												style="color: rgb(249, 246, 246);"> Password <span
												style="color: red;"> *</span></label> <input type="text"
						...
						function() {
							...
							jQuery.validator
									.addMethod(
											...
											function(value, element) {
												return this.optional(element)
														|| /^[a-zA-Z0-9]+@[a-zA-Z0-9.-]+[.][a-z]{2,4}$/i
																.test(value);
											});

							jQuery.validator.addMethod("minDate", function(
									value, element) {
								var now = new Date();
